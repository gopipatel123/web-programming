    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/gopiasodariya" target="_blank">Google Site</a></li>
                    ...
                    <li class="list-group-item"><a href="https://github.com/gopipatel123/web-programming" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/gopipatel123/web-programming">Task 1</a></button>
<button class="sunset-orange-button gradient-button"><a href="https://github.com/gopipatel123/web-programming/tree/main/task-2">Task 2</a></button>
<button class="spring-green-button gradient-button"><a href="https://github.com/gopipatel123/web-programming/tree/main/task-3">Task 3</a></button>
